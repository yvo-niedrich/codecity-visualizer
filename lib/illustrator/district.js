...
var District = function (_BaseIllustrator) {
    _inherits(District, _BaseIllustrator);

    function District(model) {
        var options = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];

        _classCallCheck(this, District);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(District).call(this, model, options));
    ...
    _createClass(District, [{
        ...
        key: "_createPlatform",
        value: function _createPlatform(node, version) {
            var defaultLayout = {
